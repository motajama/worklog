...
-- =========================================================
-- FOOTPRINT FACTORS
-- User-owned editable kgCO2e factor catalog
-- =========================================================
...
CREATE TABLE routine_footprint_items (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE entries (
    ...
    emissions_status VARCHAR(20) NOT NULL DEFAULT 'not_rated'
        CHECK (emissions_status IN ('not_rated', 'partial', 'complete')),
...
-- =========================================================
-- EVENT FOOTPRINT ITEMS
-- Snapshot rows keep historical entries stable when factors change
-- =========================================================
...
CREATE INDEX idx_footprint_factors_user
    ON footprint_factors(user_id, active, category);

CREATE INDEX idx_recurring_footprint_rules_user
    ON recurring_footprint_rules(user_id, active);

CREATE INDEX idx_recurring_footprint_instances_user_date
...
CREATE INDEX idx_routine_footprint_items_routine
...
CREATE INDEX idx_event_footprint_items_event
